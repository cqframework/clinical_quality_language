...
interface FhirTransactions : FhirTransactions {
    /**
     ...
     *
     * Note specifically that this interface can also be used to process a `batch` bundle (i.e. a
     * set of FHIR API requests that can be performed with a single API request, but does not
     * require full transaction semantics)
     *
     ...
     */
    fun transaction(transaction: Bundle?): Bundle?
}
