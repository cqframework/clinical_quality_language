...
public class LibraryTests {
    ...
    public void testMissingLibrary() {
        ...
        try {
            ...
            assertThat(translator.getErrors().size(), is(1));
            System.out.println(translator.getErrors().get(0).getMessage());
            System.out.println(translator.getErrors().get(0).getClass().getSimpleName());
            System.out.println(translator.getErrors().get(0).getCause());
