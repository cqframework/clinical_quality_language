...
public class SignatureOutputTests {
    ...
    private Library getLibrary(LibraryBuilder.SignatureLevel signatureLevel) throws IOException {
        ...
        CqlTranslator translator = CqlTranslator.fromFile(testFile, modelManager, new LibraryManager(modelManager), CqlTranslatorException.ErrorSeverity.Info, signatureLevel);
