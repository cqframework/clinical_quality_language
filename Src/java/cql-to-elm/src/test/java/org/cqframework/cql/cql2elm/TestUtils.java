...
public class TestUtils {
    ...
    public static CqlTranslator runSemanticTest(
    ...
    public static CqlTranslator runSemanticTestNoErrors(String testFileName, CqlCompilerOptions.Options... options)
            throws IOException {
    ...
    public static CqlTranslator runSemanticTest(
            String testFileName,
            int expectedErrors,
            SignatureLevel nullableSignatureLevel,
    ...
    public static CqlTranslator runSemanticTest(String testFileName, int expectedErrors, CqlCompilerOptions options)
            throws IOException {
        return runSemanticTest(null, testFileName, expectedErrors, options);
    }

    public static CqlTranslator runSemanticTest(
            NamespaceInfo namespaceInfo, String testFileName, int expectedErrors, CqlCompilerOptions.Options... options)
            throws IOException {
        final CqlCompilerOptions cqlCompilerOptions = new CqlCompilerOptions(options);
    ...
    public static CqlTranslator runSemanticTest(
            NamespaceInfo namespaceInfo, String testFileName, int expectedErrors, CqlCompilerOptions options)
            throws IOException {
    ...
    public static CqlTranslator runSemanticTestWithOrWithoutErrors(
    ...
    public static CqlTranslator createTranslatorFromStream(
            String testFileName, SignatureLevel signatureLevel, CqlCompilerOptions.Options... options)
            throws IOException {
    ...
    private static LibraryManager getLibraryManager(
            ModelManager theModelManager, CqlCompilerOptions theCompilerOptions) {
    ...
    public static CqlTranslator createTranslator(
            NamespaceInfo namespaceInfo, String testFileName, CqlCompilerOptions options) throws IOException {
    ...
    private static LibraryManager getLibraryManager(SignatureLevel nullableSignatureLevel) {
        return getLibraryManager(new CqlCompilerOptions(
                ErrorSeverity.Warning, Objects.requireNonNullElse(nullableSignatureLevel, SignatureLevel.All)));
    }
    ...
    private static LibraryManager getLibraryManager(
            CqlCompilerOptions options, ModelManager modelManager, String path) {
        final LibraryManager libraryManager = new LibraryManager(modelManager, options);
        libraryManager
                .getLibrarySourceLoader()
                .registerProvider(path == null ? new TestLibrarySourceProvider() : new TestLibrarySourceProvider(path));
        return libraryManager;
    }
}
