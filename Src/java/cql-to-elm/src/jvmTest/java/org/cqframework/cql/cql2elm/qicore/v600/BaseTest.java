...
class BaseTest {
    ...
    void medicationRequest() throws IOException {
        ...
        assertThat(r.getCodeProperty() == null, is(true));
        assertThat(r.getCodes() == null, is(true));
        assertThat(Trackable.INSTANCE.getResultType(r), instanceOf(ListType.class));
        assertThat(((ListType) Trackable.INSTANCE.getResultType(r)).getElementType(), instanceOf(ClassType.class));
        assertThat(((ClassType) ((ListType) Trackable.INSTANCE.getResultType(r)).getElementType()).getName(), is("QICore.Medication"));
