...
internal class BaseTest {
    ...
    fun choiceWithAlternativeConversion() {
        val def = TestUtils.visitFile("fhir/r4/TestChoiceTypes.cql")
    ...
    fun uriConversion() {
        ...
        TestUtils.visitFile("fhir/r4/TestURIConversion.cql")
    }

    @Test
    @Throws(IOException::class)
    fun fhirTiming() {
        val def = TestUtils.visitFile("fhir/r4/TestFHIRTiming.cql")
        // Query->
        //  where->
        //      In->
        //          left->
