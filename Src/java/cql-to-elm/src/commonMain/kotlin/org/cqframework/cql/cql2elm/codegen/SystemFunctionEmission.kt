 ...
 * for Year/Month precision is handled by the TypeUnifier (OperatorConversion synthetic on the
 * argument slot), applied by EmissionContext.applySynthetics before we get here.
 */
