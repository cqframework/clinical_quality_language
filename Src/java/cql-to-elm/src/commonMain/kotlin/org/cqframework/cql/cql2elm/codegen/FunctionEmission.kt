...
internal fun EmissionContext.emitIfExpression(
    ...
    // All conversions (choice type wrapping, implicit promotion, null-As wrapping) are
    // handled by ConversionInserter in the analysis phase via the INFER→CONVERT→CHECK loop.
    return If().apply {
