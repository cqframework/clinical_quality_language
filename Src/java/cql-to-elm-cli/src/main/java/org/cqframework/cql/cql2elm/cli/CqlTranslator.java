...
public class CqlTranslator {
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        OptionSpec<org.cqframework.cql.cql2elm.CqlTranslator.Format> format = parser.accepts("format").withRequiredArg().ofType(org.cqframework.cql.cql2elm.CqlTranslator.Format.class).defaultsTo(org.cqframework.cql.cql2elm.CqlTranslator.Format.XML).describedAs("The target format for the output");
