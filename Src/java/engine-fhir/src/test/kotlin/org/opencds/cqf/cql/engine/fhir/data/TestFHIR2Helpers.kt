...
class TestFHIR2Helpers : FhirExecutionTestBase() {
    // @Test
    // BTR-> Getting very strange behavior in the FHIR2 tests that I can't explain :(
    // Backing out of the updates to FHIR Model Info for DSTU2, would require another week I don't
    // have right now
    fun test() {
        engine.environment.registerDataProvider("http://hl7.org/fhir", dstu2Provider)
