...
class Issue1226 extends FhirExecutionTestBase {

    @Test
    void medicationReferenceFound() {
        var r = new RetrieveProvider() {
            ...
            public Iterable<Object> retrieve(
                ...
                switch (dataType) {
                    case "Patient":
                        return Collections.singletonList(new Patient().setId("123"));
                    case "MedicationRequest":
                        return Collections.singletonList(
                                new MedicationRequest().setMedication(new Reference("Medication/456")));
                }
