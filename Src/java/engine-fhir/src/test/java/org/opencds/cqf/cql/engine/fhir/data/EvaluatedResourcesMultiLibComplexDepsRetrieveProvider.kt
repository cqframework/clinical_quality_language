...
internal enum class EvaluatedResourcesMultiLibComplexDepsRetrieveProvider : RetrieveProvider {
    ...
    companion object {
        ...
        val ENCOUNTER_ARRIVED_PAT1: Encounter = buildEncounter(
            "enc_arrived_pat1",
        ...
        val ENCOUNTER_CANCELLED_PAT1: Encounter = buildEncounter(
            "enc_cancelled_pat1",
        ...
        val ENCOUNTER_FINISHED_PAT1: Encounter = buildEncounter(
            "enc_finished_pat1",
        ...
        val ENCOUNTER_PLANNED_PAT1: Encounter = buildEncounter(
            "enc_planned_pat1",
        ...
        val ENCOUNTER_TRIAGED_PAT1: Encounter = buildEncounter(
            "enc_triaged_pat1",
        ...
        val ENCOUNTER_ARRIVED_PAT2: Encounter = buildEncounter(
            "enc_arrived_pat2",
            Encounter.EncounterStatus.ARRIVED,
            LocalDate.of(2000, Month.JANUARY, 1),
            LocalDate.of(2000, Month.DECEMBER, 31),
        ...
        val ENCOUNTER_CANCELLED_PAT2: Encounter = buildEncounter(
            "enc_cancelled_pat2",
            Encounter.EncounterStatus.CANCELLED,
            LocalDate.of(2001, Month.JANUARY, 1),
            LocalDate.of(2001, Month.DECEMBER, 31),
        ...
        val ENCOUNTER_FINISHED_PAT2: Encounter = buildEncounter(
            "enc_finished_pat2",
            Encounter.EncounterStatus.FINISHED,
            LocalDate.of(2001, Month.JANUARY, 1),
            LocalDate.of(2001, Month.DECEMBER, 31),
        ...
        val ENCOUNTER_PLANNED_PAT2: Encounter = buildEncounter(
            "enc_planned_pat2",
            Encounter.EncounterStatus.PLANNED,
            LocalDate.of(2001, Month.JANUARY, 1),
            LocalDate.of(2001, Month.DECEMBER, 31),
        ...
        val ENCOUNTER_TRIAGED_PAT2: Encounter = buildEncounter(
            "enc_triaged_pat2",
            Encounter.EncounterStatus.TRIAGED,
            LocalDate.of(2001, Month.JANUARY, 1),
            LocalDate.of(2001, Month.DECEMBER, 31),
        ...
        val ENCOUNTER_ARRIVED_PAT3: Encounter = buildEncounter(
            "enc_arrived_pat3",
            Encounter.EncounterStatus.ARRIVED,
            LocalDate.of(2000, Month.JANUARY, 1),
            LocalDate.of(2000, Month.DECEMBER, 31),
        ...
        val ENCOUNTER_CANCELLED_PAT3: Encounter = buildEncounter(
            "enc_cancelled_pat3",
            Encounter.EncounterStatus.CANCELLED,
            LocalDate.of(2001, Month.JANUARY, 1),
            LocalDate.of(2001, Month.DECEMBER, 31),
        ...
        val ENCOUNTER_FINISHED_PAT3: Encounter = buildEncounter(
            "enc_finished_pat3",
            Encounter.EncounterStatus.FINISHED,
            LocalDate.of(2001, Month.JANUARY, 1),
            LocalDate.of(2001, Month.DECEMBER, 31),
        ...
        val ENCOUNTER_PLANNED_PAT3: Encounter = buildEncounter(
            "enc_planned_pat3",
            Encounter.EncounterStatus.PLANNED,
            LocalDate.of(2001, Month.JANUARY, 1),
            LocalDate.of(2001, Month.DECEMBER, 31),
        ...
        val ENCOUNTER_TRIAGED_PAT3: Encounter = buildEncounter(
            "enc_triaged_pat3",
            Encounter.EncounterStatus.TRIAGED,
            LocalDate.of(2001, Month.JANUARY, 1),
            LocalDate.of(2001, Month.DECEMBER, 31),
        ...
        val allEncounters: MutableList<Encounter?>
            get() = List.of<Encounter?>(
