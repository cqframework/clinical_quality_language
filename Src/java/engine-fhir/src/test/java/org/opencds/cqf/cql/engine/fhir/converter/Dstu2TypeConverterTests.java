...
public class Dstu2TypeConverterTests {
    ...
    public void TestQuantityToFhirQuantity() {
        org.hl7.fhir.dstu2.model.Quantity expected = new org.hl7.fhir.dstu2.model.Quantity()
                ...
                .setUnit("ml");
        org.hl7.fhir.dstu2.model.Quantity actual =
                (org.hl7.fhir.dstu2.model.Quantity) this.typeConverter.toFhirQuantity(
    ...
    public void TestRatioToFhirRatio() {
        ...
        org.hl7.fhir.dstu2.model.Ratio actual =
                (org.hl7.fhir.dstu2.model.Ratio) this.typeConverter.toFhirRatio(testData);
    ...
    public void TestToCqlType() {
        ...
        actual =
                this.typeConverter.toCqlType(new DateType(Calendar.getInstance().getTime()));
    ...
    public void TestQuantityToCqlType() {
        ...
        Quantity actual = this.typeConverter.toCqlQuantity(new org.hl7.fhir.dstu2.model.Quantity()
                .setValue(new BigDecimal("2.0"))
                .setUnit("ml")
                .setSystem("http://unitsofmeasure.org"));
    ...
    public void TestCodingToCqlCode() {
        Code expected = new Code()
                ...
                .withDisplay("system-test")
                .withVersion("1.5");
        Code actual = this.typeConverter.toCqlCode(new Coding()
                .setSystem("http://the-system.com")
                .setCode("test")
                .setDisplay("system-test")
                .setVersion("1.5"));
    ...
    public void TestCodeableConceptToCqlConcept() {
        Concept expected = new Concept()
                .withCode(new Code()
                        ...
                        .withVersion("1.5"))
                .withDisplay("additional-text");
        Concept actual = this.typeConverter.toCqlConcept(new CodeableConcept(new Coding()
                        .setSystem("http://the-system.com")
                        .setCode("test")
                        .setDisplay("system-test")
                        .setVersion("1.5"))
