...
class EvaluatedResourceTestUtils {
    ...
    static final Procedure PROCEDURE = (Procedure)new Procedure()
            .setId(new IdType(ResourceType.Procedure.name(), "Procedure1"));
    ...
    static final RetrieveProvider RETRIEVE_PROVIDER = (
            ...
            dateHighPath,
            dateRange) -> {
        logger.info("1234: RetrieveProvider: context: {}, contextPath: {}, contextValue: {}, dataType: {}, templateId: {}, codePath: {}, codes: {}, valueSet: {}, datePath: {}, dateLowPath: {}, dateHighPath: {}, dateRange: {}",
                context, contextPath, contextValue, dataType, templateId, codePath, codes, valueSet, datePath, dateLowPath, dateHighPath, dateRange);
    ...
    @Nonnull
    static CqlEngine getCqlEngineForFhir(CqlEngine cqlEngine, boolean expressionCaching, R4FhirModelResolver r4ModelResolver, RetrieveProvider retrieveProvider) {
        cqlEngine.getState()
                .getEnvironment()
                .registerDataProvider("http://hl7.org/fhir", new CompositeDataProvider(r4ModelResolver, retrieveProvider));
