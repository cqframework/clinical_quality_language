...
internal class R5TypeConverterTests {
    ...
    fun invalidIntervalToFhirPeriod() {
        ...
        Assertions.assertThrows<IllegalArgumentException?>(
            IllegalArgumentException::class.java,
            Executable { typeConverter!!.toFhirPeriod(interval) })
    }
    ...
    fun primitiveFhirTypeToCqlType() {
        ...
        val actualInteger: Int? = typeConverter!!.toCqlInteger(IntegerType(5))
    ...
    fun longToFhirType() {
        ...
        Assertions.assertInstanceOf<Integer64Type?>(Integer64Type::class.java, actual)
        Assertions.assertEquals(5L, (actual as Integer64Type).getValue())
    }
