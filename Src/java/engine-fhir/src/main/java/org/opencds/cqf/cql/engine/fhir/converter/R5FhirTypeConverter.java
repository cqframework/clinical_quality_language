...
class R5FhirTypeConverter extends BaseFhirTypeConverter {
    ...
    public ICompositeType toFhirRatio(Ratio value) {
        ...
        return new org.hl7.fhir.r5.model.Ratio()
                .setNumerator((org.hl7.fhir.r5.model.Quantity) toFhirQuantity(value.getNumerator()))
                .setDenominator((org.hl7.fhir.r5.model.Quantity) toFhirQuantity(value.getDenominator()));
    }
    ...
    public ICompositeType toFhirRange(Interval value) {
        ...
        range.setLow((org.hl7.fhir.r5.model.Quantity) toFhirQuantity((Quantity) value.getStart()));
        range.setHigh((org.hl7.fhir.r5.model.Quantity) toFhirQuantity((Quantity) value.getEnd()));
    ...
    public Quantity toCqlQuantity(ICompositeType value) {
        ...
        org.hl7.fhir.r5.model.Quantity quantity = (org.hl7.fhir.r5.model.Quantity) value;
