...
internal class R4FhirTypeConverter : BaseFhirTypeConverter() {
    ...
    override fun toFhirInteger64(value: Long?): IPrimitiveType<Long> {
        throw IllegalArgumentException("FHIR R4 does not support Long/Integer64 values")
    }
    ...
    override fun toFhirRatio(value: Ratio?): ICompositeType? {
        ...
        return org.hl7.fhir.r4.model
            .Ratio()
            .setNumerator(toFhirQuantity(value.numerator) as org.hl7.fhir.r4.model.Quantity?)
            .setDenominator(toFhirQuantity(value.denominator) as org.hl7.fhir.r4.model.Quantity?)
    }
    ...
    override fun toFhirRange(value: Interval?): ICompositeType? {
        ...
        val range = Range()
        range.setLow(toFhirQuantity(value.start as Quantity?) as org.hl7.fhir.r4.model.Quantity?)
        range.setHigh(toFhirQuantity(value.end as Quantity?) as org.hl7.fhir.r4.model.Quantity?)
    ...
    override fun toCqlQuantity(value: ICompositeType?): Quantity? {
        ...
        val quantity = value as org.hl7.fhir.r4.model.Quantity
