...
internal class R5FhirTypeConverter : BaseFhirTypeConverter() {
    ...
    override fun toFhirInteger64(value: Long?): IPrimitiveType<kotlin.Long>? {
        ...
        return Integer64Type(value.value)
    }
    ...
    override fun toFhirRatio(value: Ratio?): ICompositeType? {
        ...
        return org.hl7.fhir.r5.model
            .Ratio()
            .setNumerator(toFhirQuantity(value.numerator) as org.hl7.fhir.r5.model.Quantity?)
            .setDenominator(toFhirQuantity(value.denominator) as org.hl7.fhir.r5.model.Quantity?)
    }
    ...
    override fun toFhirRange(value: Interval?): ICompositeType? {
        ...
        val range = Range()
        range.setLow(toFhirQuantity(value.start as Quantity?) as org.hl7.fhir.r5.model.Quantity?)
        range.setHigh(toFhirQuantity(value.end as Quantity?) as org.hl7.fhir.r5.model.Quantity?)
    ...
    override fun toCqlQuantity(value: ICompositeType?): Quantity? {
        ...
        val quantity = value as org.hl7.fhir.r5.model.Quantity
    ...
    override fun toCqlRatio(value: ICompositeType?): Ratio? {
        ...
        val ratio = value as org.hl7.fhir.r5.model.Ratio
        ...
        return Concept()
            ...
            .withCodes(
                codeableConcept
                    .getCoding()
                    .stream()
                    .map<Code?> { value: Coding? -> this.toCqlCode(value) }
    ...
    override fun toCqlDate(value: IPrimitiveType<Date>?): org.opencds.cqf.cql.engine.runtime.Date? {
        ...
        when (baseDateTime.precision) {
            ...
            TemporalPrecisionEnum.MONTH ->
                return toDate(baseDateTime.valueAsCalendar, baseDateTime.precision.calendarConstant)
    ...
    override fun toCqlDateTime(value: IPrimitiveType<Date>?): DateTime? {
        ...
        if (value.fhirType() == "instant" || value.fhirType() == "dateTime") {
            val baseDateTime = value as BaseDateTimeType
            return toDateTime(baseDateTime.valueAsCalendar, baseDateTime.precision.calendarConstant)
        } else {
    ...
    companion object {
        private fun emptyBooleanWithExtension(url: kotlin.String?, value: DataType?): BooleanType {
        ...
        private fun addPartWithNameAndValue(
            ...
            if (value is Parameters.ParametersParameterComponent) {
                ...
                when (value) {
                    is Resource -> part.setResource(value)
                    is DataType -> part.setValue(value)
                    else ->
                        throw IllegalArgumentException(
