...
internal class Dstu3FhirTypeConverter : BaseFhirTypeConverter() {
    ...
    override fun toFhirInteger64(value: Long?): IPrimitiveType<Long> {
        throw IllegalArgumentException("FHIR DSTU3 does not support Long/Integer64 values")
    }
    ...
    override fun toFhirQuantity(value: Quantity?): ICompositeType? {
        ...
        return org.hl7.fhir.dstu3.model
            .Quantity()
            .setSystem(system)
            .setCode(ucumUnit)
    ...
    override fun toFhirRatio(value: Ratio?): ICompositeType? {
        ...
        return org.hl7.fhir.dstu3.model
            .Ratio()
            .setNumerator(toFhirQuantity(value.numerator) as org.hl7.fhir.dstu3.model.Quantity?)
            .setDenominator(toFhirQuantity(value.denominator) as org.hl7.fhir.dstu3.model.Quantity?)
    }
    ...
    override fun toFhirRange(value: Interval?): ICompositeType? {
        ...
        val range = Range()
        val start = toFhirQuantity(value.start as Quantity?) as org.hl7.fhir.dstu3.model.Quantity?
        if (start != null) {
            range.setLow(start.castToSimpleQuantity(start))
        }

        val end = toFhirQuantity(value.end as Quantity?) as org.hl7.fhir.dstu3.model.Quantity?
        if (end != null) {
    ...
    override fun toCqlQuantity(value: ICompositeType?): Quantity? {
        ...
        val quantity = value as org.hl7.fhir.dstu3.model.Quantity
    ...
    override fun toCqlRatio(value: ICompositeType?): Ratio? {
        ...
        val ratio = value as org.hl7.fhir.dstu3.model.Ratio
