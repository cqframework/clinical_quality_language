...
@XmlType(name = "Floor", namespace = "urn:hl7-org:elm:r1")
public class Floor
    ...
    implements Equals, HashCode, ToString
{
    ...
    @Override
    public Floor withOperand(Expression value) {
        setOperand(value);
        return this;
    }

    @Override
    public Floor withAnnotation(Object... values) {
        if (values!= null) {
    ...
    @Override
    public Floor withAnnotation(Collection<Object> values) {
        if (values!= null) {
    ...
    @Override
    public Floor withLocalId(String value) {
        setLocalId(value);
        return this;
    }
