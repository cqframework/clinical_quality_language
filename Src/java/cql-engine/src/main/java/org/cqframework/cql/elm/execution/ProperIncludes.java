 ...
 * 	
 * For the List, List overload, this operator returns true if the first list includes every element of the second list, using equivalence semantics, and first list is strictly larger.
 * 
...
@XmlType(name = "ProperIncludes", namespace = "urn:hl7-org:elm:r1")
    ...
    implements Equals, HashCode, ToString
{
    ...
    public ProperIncludes withPrecision(DateTimePrecision value) {
        setPrecision(value);
        return this;
    }

    @Override
    public ProperIncludes withOperand(Expression... values) {
        if (values!= null) {
    ...
    @Override
    public ProperIncludes withOperand(Collection<Expression> values) {
        if (values!= null) {
    ...
    @Override
    public ProperIncludes withAnnotation(Object... values) {
        if (values!= null) {
    ...
    @Override
    public ProperIncludes withAnnotation(Collection<Object> values) {
        if (values!= null) {
    ...
    @Override
    public ProperIncludes withLocalId(String value) {
        setLocalId(value);
        return this;
    }

    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof ProperIncludes)) {
            return false;
        }
        if (this == object) {
            return true;
        ...
        final ProperIncludes that = ((ProperIncludes) object);
        {
