...
@XmlType(name = "ToInteger", namespace = "urn:hl7-org:elm:r1")
    ...
    implements Equals, HashCode, ToString
{
    ...
    @Override
    public ToInteger withOperand(Expression value) {
        setOperand(value);
        return this;
    }

    @Override
    public ToInteger withAnnotation(Object... values) {
        if (values!= null) {
    ...
    @Override
    public ToInteger withAnnotation(Collection<Object> values) {
        if (values!= null) {
    ...
    @Override
    public ToInteger withLocalId(String value) {
        setLocalId(value);
        return this;
    }

    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof ToInteger)) {
            return false;
        }
        if (this == object) {
            return true;
