...
@XmlType(name = "Without", namespace = "urn:hl7-org:elm:r1")
    ...
    implements Equals, HashCode, ToString
{
    ...
    @Override
    public Without withSuchThat(Expression value) {
        setSuchThat(value);
        return this;
    }

    @Override
    public Without withExpression(Expression value) {
        setExpression(value);
        return this;
    }

    @Override
    public Without withAlias(String value) {
        setAlias(value);
        return this;
    }

    @Override
    public Without withAnnotation(Object... values) {
        if (values!= null) {
    ...
    @Override
    public Without withAnnotation(Collection<Object> values) {
        if (values!= null) {
    ...
    @Override
    public Without withLocalId(String value) {
        setLocalId(value);
        return this;
    }

    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof Without)) {
            return false;
        }
        if (this == object) {
            return true;
