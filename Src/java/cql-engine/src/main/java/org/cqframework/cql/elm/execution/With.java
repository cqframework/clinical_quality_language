...
@XmlType(name = "With", namespace = "urn:hl7-org:elm:r1")
public class With
    ...
    implements Equals, HashCode, ToString
{
    ...
    @Override
    public With withSuchThat(Expression value) {
        setSuchThat(value);
        return this;
    }

    @Override
    public With withExpression(Expression value) {
        setExpression(value);
        return this;
    }

    @Override
    public With withAlias(String value) {
        setAlias(value);
        return this;
    }

    @Override
    public With withAnnotation(Object... values) {
        if (values!= null) {
    ...
    @Override
    public With withAnnotation(Collection<Object> values) {
        if (values!= null) {
    ...
    @Override
    public With withLocalId(String value) {
        setLocalId(value);
        return this;
    }

    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof With)) {
            return false;
        }
        if (this == object) {
            return true;
