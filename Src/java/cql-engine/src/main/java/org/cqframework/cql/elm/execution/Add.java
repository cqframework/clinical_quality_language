 ...
 * 			
 * When adding quantities, the dimensions of each quantity must be the same, but not necessarily the unit. For example, units of 'cm' and 'm' can be added, but units of 'cm2' and 'cm' cannot. The unit of the result will be the most granular unit of either input.
 * 			
    ...
    implements Equals, HashCode, ToString
{
    ...
    @Override
    public Add withOperand(Collection<Expression> values) {
        if (values!= null) {
    ...
    @Override
    public Add withAnnotation(Collection<Object> values) {
        if (values!= null) {
    ...
    @Override
    public Add withLocalId(String value) {
        setLocalId(value);
        return this;
    }
