...
@XmlType(name = "Abs", namespace = "urn:hl7-org:elm:r1")
public class Abs
    ...
    implements Equals, HashCode, ToString
{
    ...
    @Override
    public Abs withOperand(Expression value) {
        setOperand(value);
        return this;
    }

    @Override
    public Abs withAnnotation(Object... values) {
        if (values!= null) {
    ...
    @Override
    public Abs withAnnotation(Collection<Object> values) {
        if (values!= null) {
    ...
    @Override
    public Abs withLocalId(String value) {
        setLocalId(value);
        return this;
    }

    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof Abs)) {
            return false;
        }
        if (this == object) {
            return true;
