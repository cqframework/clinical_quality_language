    ...
    implements Equals, HashCode, ToString
{
    ...
    @Override
    public After withOperand(Collection<Expression> values) {
        if (values!= null) {
    ...
    @Override
    public After withAnnotation(Collection<Object> values) {
        if (values!= null) {
    ...
    @Override
    public After withLocalId(String value) {
        setLocalId(value);
        return this;
    }
