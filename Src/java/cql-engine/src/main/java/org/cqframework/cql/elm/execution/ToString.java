...
@XmlType(name = "ToString", namespace = "urn:hl7-org:elm:r1")
    ...
    implements Equals, HashCode, org.jvnet.jaxb2_commons.lang.ToString
{
    ...
    @Override
    public ToString withOperand(Expression value) {
        setOperand(value);
        return this;
    }

    @Override
    public ToString withAnnotation(Object... values) {
        if (values!= null) {
    ...
    @Override
    public ToString withAnnotation(Collection<Object> values) {
        if (values!= null) {
    ...
    @Override
    public ToString withLocalId(String value) {
        setLocalId(value);
        return this;
    }
