...
@XmlType(name = "Mode", namespace = "urn:hl7-org:elm:r1")
public class Mode
    ...
    implements Equals, HashCode, ToString
{
    ...
    @Override
    public Mode withSource(Expression value) {
        setSource(value);
        return this;
    }

    @Override
    public Mode withPath(String value) {
        setPath(value);
        return this;
    }

    @Override
    public Mode withAnnotation(Object... values) {
        if (values!= null) {
    ...
    @Override
    public Mode withAnnotation(Collection<Object> values) {
        if (values!= null) {
    ...
    @Override
    public Mode withLocalId(String value) {
        setLocalId(value);
        return this;
    }
