...
@XmlType(name = "Today", namespace = "urn:hl7-org:elm:r1")
public class Today
    extends Expression
    implements Equals, HashCode, ToString
{
    ...
    @Override
    public Today withAnnotation(Object... values) {
        if (values!= null) {
    ...
    @Override
    public Today withAnnotation(Collection<Object> values) {
        if (values!= null) {
    ...
    @Override
    public Today withLocalId(String value) {
        setLocalId(value);
        return this;
    }
