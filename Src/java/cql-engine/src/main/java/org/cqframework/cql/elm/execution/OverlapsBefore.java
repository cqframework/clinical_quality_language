...
@XmlType(name = "OverlapsBefore", namespace = "urn:hl7-org:elm:r1")
    ...
    implements Equals, HashCode, ToString
{
    ...
    public OverlapsBefore withPrecision(DateTimePrecision value) {
        setPrecision(value);
        return this;
    }

    @Override
    public OverlapsBefore withOperand(Expression... values) {
        if (values!= null) {
    ...
    @Override
    public OverlapsBefore withOperand(Collection<Expression> values) {
        if (values!= null) {
    ...
    @Override
    public OverlapsBefore withAnnotation(Object... values) {
        if (values!= null) {
    ...
    @Override
    public OverlapsBefore withAnnotation(Collection<Object> values) {
        if (values!= null) {
    ...
    @Override
    public OverlapsBefore withLocalId(String value) {
        setLocalId(value);
        return this;
    }

    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof OverlapsBefore)) {
            return false;
        }
        if (this == object) {
            return true;
        ...
        final OverlapsBefore that = ((OverlapsBefore) object);
        {
