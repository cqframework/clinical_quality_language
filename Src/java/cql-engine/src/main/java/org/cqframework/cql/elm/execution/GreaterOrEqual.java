...
@XmlType(name = "GreaterOrEqual", namespace = "urn:hl7-org:elm:r1")
    ...
    implements Equals, HashCode, ToString
{
    ...
    @Override
    public GreaterOrEqual withOperand(Collection<Expression> values) {
        if (values!= null) {
    ...
    @Override
    public GreaterOrEqual withAnnotation(Object... values) {
        if (values!= null) {
    ...
    @Override
    public GreaterOrEqual withAnnotation(Collection<Object> values) {
        if (values!= null) {
    ...
    @Override
    public GreaterOrEqual withLocalId(String value) {
        setLocalId(value);
        return this;
    }
