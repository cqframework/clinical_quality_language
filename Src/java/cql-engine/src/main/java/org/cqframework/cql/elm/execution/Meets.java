...
@XmlType(name = "Meets", namespace = "urn:hl7-org:elm:r1")
public class Meets
    ...
    implements Equals, HashCode, ToString
{
    ...
    public Meets withPrecision(DateTimePrecision value) {
        setPrecision(value);
        return this;
    }

    @Override
    public Meets withOperand(Expression... values) {
        if (values!= null) {
    ...
    @Override
    public Meets withOperand(Collection<Expression> values) {
        if (values!= null) {
    ...
    @Override
    public Meets withAnnotation(Object... values) {
        if (values!= null) {
    ...
    @Override
    public Meets withAnnotation(Collection<Object> values) {
        if (values!= null) {
    ...
    @Override
    public Meets withLocalId(String value) {
        setLocalId(value);
        return this;
    }

    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof Meets)) {
            return false;
        }
        if (this == object) {
            return true;
