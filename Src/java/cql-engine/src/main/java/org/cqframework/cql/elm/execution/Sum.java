...
@XmlType(name = "Sum", namespace = "urn:hl7-org:elm:r1")
public class Sum
    ...
    implements Equals, HashCode, ToString
{
    ...
    @Override
    public Sum withSource(Expression value) {
        setSource(value);
        return this;
    }

    @Override
    public Sum withPath(String value) {
        setPath(value);
        return this;
    }

    @Override
    public Sum withAnnotation(Object... values) {
        if (values!= null) {
    ...
    @Override
    public Sum withAnnotation(Collection<Object> values) {
        if (values!= null) {
    ...
    @Override
    public Sum withLocalId(String value) {
        setLocalId(value);
        return this;
    }
