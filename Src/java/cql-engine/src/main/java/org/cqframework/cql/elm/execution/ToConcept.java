...
@XmlType(name = "ToConcept", namespace = "urn:hl7-org:elm:r1")
    ...
    implements Equals, HashCode, ToString
{
    ...
    @Override
    public ToConcept withOperand(Expression value) {
        setOperand(value);
        return this;
    }

    @Override
    public ToConcept withAnnotation(Object... values) {
        if (values!= null) {
    ...
    @Override
    public ToConcept withAnnotation(Collection<Object> values) {
        if (values!= null) {
    ...
    @Override
    public ToConcept withLocalId(String value) {
        setLocalId(value);
        return this;
    }

    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof ToConcept)) {
            return false;
        }
        if (this == object) {
            return true;
