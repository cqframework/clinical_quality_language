 ...
 * 	
 * For the List, T overload, this operator returns true if the given element is in the list, using equivalence semantics.
 * 
...
@XmlType(name = "Contains", namespace = "urn:hl7-org:elm:r1")
    ...
    implements Equals, HashCode, ToString
{
    ...
    public Contains withPrecision(DateTimePrecision value) {
        setPrecision(value);
        return this;
    }

    @Override
    public Contains withOperand(Expression... values) {
        if (values!= null) {
    ...
    @Override
    public Contains withOperand(Collection<Expression> values) {
        if (values!= null) {
    ...
    @Override
    public Contains withAnnotation(Object... values) {
        if (values!= null) {
    ...
    @Override
    public Contains withAnnotation(Collection<Object> values) {
        if (values!= null) {
    ...
    @Override
    public Contains withLocalId(String value) {
        setLocalId(value);
        return this;
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        final Contains that = ((Contains) object);
        {
