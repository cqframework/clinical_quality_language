...
@XmlType(name = "Width", namespace = "urn:hl7-org:elm:r1")
public class Width
    ...
    implements Equals, HashCode, ToString
{
    ...
    @Override
    public Width withOperand(Expression value) {
        setOperand(value);
        return this;
    }

    @Override
    public Width withAnnotation(Object... values) {
        if (values!= null) {
    ...
    @Override
    public Width withAnnotation(Collection<Object> values) {
        if (values!= null) {
    ...
    @Override
    public Width withLocalId(String value) {
        setLocalId(value);
        return this;
    }

    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof Width)) {
            return false;
        }
        if (this == object) {
            return true;
