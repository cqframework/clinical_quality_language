...
@XmlType(name = "Collapse", namespace = "urn:hl7-org:elm:r1")
    ...
    implements Equals, HashCode, ToString
{
    ...
    @Override
    public Collapse withOperand(Expression value) {
        setOperand(value);
        return this;
    }

    @Override
    public Collapse withAnnotation(Object... values) {
        if (values!= null) {
    ...
    @Override
    public Collapse withAnnotation(Collection<Object> values) {
        if (values!= null) {
    ...
    @Override
    public Collapse withLocalId(String value) {
        setLocalId(value);
        return this;
    }
