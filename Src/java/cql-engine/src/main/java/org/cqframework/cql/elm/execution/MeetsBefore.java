 ...
 * 
 * <p>Java class for MeetsBefore complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="MeetsBefore"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "MeetsBefore", namespace = "urn:hl7-org:elm:r1")
public class MeetsBefore
    ...
    implements Equals, HashCode, ToString
{
    ...
    public MeetsBefore withPrecision(DateTimePrecision value) {
        setPrecision(value);
        return this;
    }

    @Override
    public MeetsBefore withOperand(Expression... values) {
        if (values!= null) {
    ...
    @Override
    public MeetsBefore withOperand(Collection<Expression> values) {
        if (values!= null) {
    ...
    @Override
    public MeetsBefore withAnnotation(Object... values) {
        if (values!= null) {
    ...
    @Override
    public MeetsBefore withAnnotation(Collection<Object> values) {
        if (values!= null) {
    ...
    @Override
    public MeetsBefore withLocalId(String value) {
        setLocalId(value);
        return this;
    }

    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof MeetsBefore)) {
            return false;
        }
        if (this == object) {
            return true;
        ...
        final MeetsBefore that = ((MeetsBefore) object);
        {
