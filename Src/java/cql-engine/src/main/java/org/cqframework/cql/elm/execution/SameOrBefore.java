...
@XmlType(name = "SameOrBefore", namespace = "urn:hl7-org:elm:r1")
    ...
    implements Equals, HashCode, ToString
{
    ...
    public SameOrBefore withPrecision(DateTimePrecision value) {
        setPrecision(value);
        return this;
    }

    @Override
    public SameOrBefore withOperand(Expression... values) {
        if (values!= null) {
    ...
    @Override
    public SameOrBefore withOperand(Collection<Expression> values) {
        if (values!= null) {
    ...
    @Override
    public SameOrBefore withAnnotation(Object... values) {
        if (values!= null) {
    ...
    @Override
    public SameOrBefore withAnnotation(Collection<Object> values) {
        if (values!= null) {
    ...
    @Override
    public SameOrBefore withLocalId(String value) {
        setLocalId(value);
        return this;
    }

    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof SameOrBefore)) {
            return false;
        }
        if (this == object) {
            return true;
        ...
        final SameOrBefore that = ((SameOrBefore) object);
        {
