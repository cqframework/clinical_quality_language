...
@XmlType(name = "Upper", namespace = "urn:hl7-org:elm:r1")
public class Upper
    ...
    implements Equals, HashCode, ToString
{
    ...
    @Override
    public Upper withOperand(Expression value) {
        setOperand(value);
        return this;
    }

    @Override
    public Upper withAnnotation(Object... values) {
        if (values!= null) {
    ...
    @Override
    public Upper withAnnotation(Collection<Object> values) {
        if (values!= null) {
    ...
    @Override
    public Upper withLocalId(String value) {
        setLocalId(value);
        return this;
    }

    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof Upper)) {
            return false;
        }
        if (this == object) {
            return true;
