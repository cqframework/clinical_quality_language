...
@XmlType(name = "AllTrue", namespace = "urn:hl7-org:elm:r1")
    ...
    implements Equals, HashCode, ToString
{
    ...
    @Override
    public AllTrue withSource(Expression value) {
        setSource(value);
        return this;
    }

    @Override
    public AllTrue withPath(String value) {
        setPath(value);
        return this;
    }

    @Override
    public AllTrue withAnnotation(Object... values) {
        if (values!= null) {
    ...
    @Override
    public AllTrue withAnnotation(Collection<Object> values) {
        if (values!= null) {
    ...
    @Override
    public AllTrue withLocalId(String value) {
        setLocalId(value);
        return this;
    }

    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof AllTrue)) {
            return false;
        }
        if (this == object) {
            return true;
