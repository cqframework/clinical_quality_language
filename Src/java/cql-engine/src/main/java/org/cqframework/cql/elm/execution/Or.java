    ...
    implements Equals, HashCode, ToString
{
    ...
    @Override
    public Or withOperand(Expression... values) {
        if (values!= null) {
    ...
    @Override
    public Or withOperand(Collection<Expression> values) {
        if (values!= null) {
    ...
    @Override
    public Or withAnnotation(Object... values) {
        if (values!= null) {
    ...
    @Override
    public Or withAnnotation(Collection<Object> values) {
        if (values!= null) {
    ...
    @Override
    public Or withLocalId(String value) {
        setLocalId(value);
        return this;
    }
