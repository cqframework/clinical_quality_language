...
@XmlType(name = "CalculateAgeAt", namespace = "urn:hl7-org:elm:r1")
    ...
    implements Equals, HashCode, ToString
{
    ...
    public CalculateAgeAt withPrecision(DateTimePrecision value) {
        setPrecision(value);
        return this;
    }

    @Override
    public CalculateAgeAt withOperand(Expression... values) {
        if (values!= null) {
    ...
    @Override
    public CalculateAgeAt withOperand(Collection<Expression> values) {
        if (values!= null) {
    ...
    @Override
    public CalculateAgeAt withAnnotation(Object... values) {
        if (values!= null) {
    ...
    @Override
    public CalculateAgeAt withAnnotation(Collection<Object> values) {
        if (values!= null) {
    ...
    @Override
    public CalculateAgeAt withLocalId(String value) {
        setLocalId(value);
        return this;
    }

    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof CalculateAgeAt)) {
            return false;
        }
        if (this == object) {
            return true;
        ...
        final CalculateAgeAt that = ((CalculateAgeAt) object);
        {
