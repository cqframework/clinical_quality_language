 ...
 * 
 * <p>Java class for SameOrAfter complex type.
 * 
...
@XmlType(name = "SameOrAfter", namespace = "urn:hl7-org:elm:r1")
public class SameOrAfter
    ...
    implements Equals, HashCode, ToString
{
    ...
    public SameOrAfter withPrecision(DateTimePrecision value) {
        setPrecision(value);
        return this;
    }

    @Override
    public SameOrAfter withOperand(Expression... values) {
        if (values!= null) {
    ...
    @Override
    public SameOrAfter withOperand(Collection<Expression> values) {
        if (values!= null) {
    ...
    @Override
    public SameOrAfter withAnnotation(Object... values) {
        if (values!= null) {
    ...
    @Override
    public SameOrAfter withAnnotation(Collection<Object> values) {
        if (values!= null) {
    ...
    @Override
    public SameOrAfter withLocalId(String value) {
        setLocalId(value);
        return this;
    }

    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof SameOrAfter)) {
            return false;
        }
        if (this == object) {
            return true;
        ...
        final SameOrAfter that = ((SameOrAfter) object);
        {
