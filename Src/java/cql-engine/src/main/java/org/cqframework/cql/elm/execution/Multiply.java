...
@XmlType(name = "Multiply", namespace = "urn:hl7-org:elm:r1")
    ...
    implements Equals, HashCode, ToString
{
    ...
    @Override
    public Multiply withOperand(Expression... values) {
        if (values!= null) {
    ...
    @Override
    public Multiply withOperand(Collection<Expression> values) {
        if (values!= null) {
    ...
    @Override
    public Multiply withAnnotation(Object... values) {
        if (values!= null) {
    ...
    @Override
    public Multiply withAnnotation(Collection<Object> values) {
        if (values!= null) {
    ...
    @Override
    public Multiply withLocalId(String value) {
        setLocalId(value);
        return this;
    }
