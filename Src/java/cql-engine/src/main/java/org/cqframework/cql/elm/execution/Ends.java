...
@XmlType(name = "Ends", namespace = "urn:hl7-org:elm:r1")
public class Ends
    ...
    implements Equals, HashCode, ToString
{
    ...
    public Ends withPrecision(DateTimePrecision value) {
        setPrecision(value);
        return this;
    }

    @Override
    public Ends withOperand(Expression... values) {
        if (values!= null) {
    ...
    @Override
    public Ends withOperand(Collection<Expression> values) {
        if (values!= null) {
    ...
    @Override
    public Ends withAnnotation(Object... values) {
        if (values!= null) {
    ...
    @Override
    public Ends withAnnotation(Collection<Object> values) {
        if (values!= null) {
    ...
    @Override
    public Ends withLocalId(String value) {
        setLocalId(value);
        return this;
    }

    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof Ends)) {
            return false;
        }
        if (this == object) {
            return true;
