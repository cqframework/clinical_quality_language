 ...
 * 
 * <p>Java class for DurationBetween complex type.
 * 
...
@XmlType(name = "DurationBetween", namespace = "urn:hl7-org:elm:r1")
    ...
    implements Equals, HashCode, ToString
{
    ...
    public DurationBetween withPrecision(DateTimePrecision value) {
        setPrecision(value);
        return this;
    }

    @Override
    public DurationBetween withOperand(Expression... values) {
        if (values!= null) {
    ...
    @Override
    public DurationBetween withOperand(Collection<Expression> values) {
        if (values!= null) {
    ...
    @Override
    public DurationBetween withAnnotation(Object... values) {
        if (values!= null) {
    ...
    @Override
    public DurationBetween withAnnotation(Collection<Object> values) {
        if (values!= null) {
    ...
    @Override
    public DurationBetween withLocalId(String value) {
        setLocalId(value);
        return this;
    }

    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof DurationBetween)) {
            return false;
        }
        if (this == object) {
            return true;
        ...
        final DurationBetween that = ((DurationBetween) object);
        {
