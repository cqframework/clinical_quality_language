...
@XmlType(name = "Not", namespace = "urn:hl7-org:elm:r1")
public class Not
    ...
    implements Equals, HashCode, ToString
{
    ...
    @Override
    public Not withOperand(Expression value) {
        setOperand(value);
        return this;
    }

    @Override
    public Not withAnnotation(Object... values) {
        if (values!= null) {
    ...
    @Override
    public Not withAnnotation(Collection<Object> values) {
        if (values!= null) {
    ...
    @Override
    public Not withLocalId(String value) {
        setLocalId(value);
        return this;
    }
