...
@XmlType(name = "First", namespace = "urn:hl7-org:elm:r1", propOrder = {
    "source"
})
public class First
    extends Expression
    implements Equals, HashCode, ToString
{
    ...
    public First withSource(Expression value) {
        setSource(value);
        return this;
    }

    public First withOrderBy(String value) {
        setOrderBy(value);
        return this;
    }

    @Override
    public First withAnnotation(Object... values) {
        if (values!= null) {
    ...
    @Override
    public First withAnnotation(Collection<Object> values) {
        if (values!= null) {
    ...
    @Override
    public First withLocalId(String value) {
        setLocalId(value);
        return this;
    }
