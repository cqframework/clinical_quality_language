...
@XmlType(name = "IsTrue", namespace = "urn:hl7-org:elm:r1")
public class IsTrue
    ...
    implements Equals, HashCode, ToString
{
    ...
    @Override
    public IsTrue withOperand(Expression value) {
        setOperand(value);
        return this;
    }

    @Override
    public IsTrue withAnnotation(Object... values) {
        if (values!= null) {
    ...
    @Override
    public IsTrue withAnnotation(Collection<Object> values) {
        if (values!= null) {
    ...
    @Override
    public IsTrue withLocalId(String value) {
        setLocalId(value);
        return this;
    }

    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof IsTrue)) {
            return false;
        }
        if (this == object) {
            return true;
