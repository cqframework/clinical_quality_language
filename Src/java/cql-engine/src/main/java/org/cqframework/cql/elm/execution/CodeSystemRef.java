    ...
    implements Equals, HashCode, ToString
{
    ...
    @Override
    public CodeSystemRef withAnnotation(Collection<Object> values) {
        if (values!= null) {
    ...
    @Override
    public CodeSystemRef withLocalId(String value) {
        setLocalId(value);
        return this;
    }

    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof CodeSystemRef)) {
            return false;
        }
        if (this == object) {
            return true;
        ...
        final CodeSystemRef that = ((CodeSystemRef) object);
        {
            String lhsName;
