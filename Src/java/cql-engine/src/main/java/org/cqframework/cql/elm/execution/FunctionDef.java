...
@XmlType(name = "FunctionDef", namespace = "urn:hl7-org:elm:r1", propOrder = {
    "operand"
})
    ...
    implements Equals, HashCode, ToString
{
    ...
    public FunctionDef withOperand(Collection<OperandDef> values) {
        if (values!= null) {
    ...
    @Override
    public FunctionDef withName(String value) {
        setName(value);
        return this;
    }

    @Override
    public FunctionDef withContext(String value) {
        setContext(value);
        return this;
    }
    ...
    @Override
    public FunctionDef withAnnotation(Object... values) {
        if (values!= null) {
    ...
    @Override
    public FunctionDef withAnnotation(Collection<Object> values) {
        if (values!= null) {
    ...
    @Override
    public FunctionDef withLocalId(String value) {
        setLocalId(value);
        return this;
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        final FunctionDef that = ((FunctionDef) object);
        {
            List<OperandDef> lhsOperand;
            lhsOperand = (((this.operand!= null)&&(!this.operand.isEmpty()))?this.getOperand():null);
            List<OperandDef> rhsOperand;
