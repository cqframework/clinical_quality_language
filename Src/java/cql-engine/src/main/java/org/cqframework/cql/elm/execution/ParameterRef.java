...
@XmlType(name = "ParameterRef", namespace = "urn:hl7-org:elm:r1")
    ...
    implements Equals, HashCode, ToString
{
    ...
    public ParameterRef withName(String value) {
        setName(value);
        return this;
    }

    public ParameterRef withLibraryName(String value) {
        setLibraryName(value);
        return this;
    }

    @Override
    public ParameterRef withAnnotation(Object... values) {
        if (values!= null) {
    ...
    @Override
    public ParameterRef withAnnotation(Collection<Object> values) {
        if (values!= null) {
    ...
    @Override
    public ParameterRef withLocalId(String value) {
        setLocalId(value);
        return this;
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        final ParameterRef that = ((ParameterRef) object);
        {
            String lhsName;
