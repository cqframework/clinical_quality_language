...
@XmlType(name = "End", namespace = "urn:hl7-org:elm:r1")
public class End
    ...
    implements Equals, HashCode, ToString
{
    ...
    @Override
    public End withOperand(Expression value) {
        setOperand(value);
        return this;
    }

    @Override
    public End withAnnotation(Object... values) {
        if (values!= null) {
    ...
    @Override
    public End withAnnotation(Collection<Object> values) {
        if (values!= null) {
    ...
    @Override
    public End withLocalId(String value) {
        setLocalId(value);
        return this;
    }
