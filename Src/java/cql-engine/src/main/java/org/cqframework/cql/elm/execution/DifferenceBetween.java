...
@XmlType(name = "DifferenceBetween", namespace = "urn:hl7-org:elm:r1")
    ...
    implements Equals, HashCode, ToString
{
    ...
    public DifferenceBetween withPrecision(DateTimePrecision value) {
        setPrecision(value);
        return this;
    }

    @Override
    public DifferenceBetween withOperand(Expression... values) {
        if (values!= null) {
    ...
    @Override
    public DifferenceBetween withOperand(Collection<Expression> values) {
        if (values!= null) {
    ...
    @Override
    public DifferenceBetween withAnnotation(Object... values) {
        if (values!= null) {
    ...
    @Override
    public DifferenceBetween withAnnotation(Collection<Object> values) {
        if (values!= null) {
    ...
    @Override
    public DifferenceBetween withLocalId(String value) {
        setLocalId(value);
        return this;
    }

    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof DifferenceBetween)) {
            return false;
        }
        if (this == object) {
            return true;
        ...
        final DifferenceBetween that = ((DifferenceBetween) object);
        {
