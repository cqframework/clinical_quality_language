...
@XmlType(name = "TypeSpecifier", namespace = "urn:hl7-org:elm:r1")
@XmlSeeAlso({
    ...
    implements Equals, HashCode, ToString
{
    ...
    @Override
    public TypeSpecifier withAnnotation(Object... values) {
        if (values!= null) {
    ...
    @Override
    public TypeSpecifier withAnnotation(Collection<Object> values) {
        if (values!= null) {
    ...
    @Override
    public TypeSpecifier withLocalId(String value) {
        setLocalId(value);
        return this;
    }

    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof TypeSpecifier)) {
            return false;
        }
        if (this == object) {
            return true;
