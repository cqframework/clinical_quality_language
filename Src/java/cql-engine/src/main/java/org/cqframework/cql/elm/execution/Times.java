...
@XmlType(name = "Times", namespace = "urn:hl7-org:elm:r1")
public class Times
    ...
    implements Equals, HashCode, ToString
{
    ...
    @Override
    public Times withOperand(Expression... values) {
        if (values!= null) {
    ...
    @Override
    public Times withOperand(Collection<Expression> values) {
        if (values!= null) {
    ...
    @Override
    public Times withAnnotation(Object... values) {
        if (values!= null) {
    ...
    @Override
    public Times withAnnotation(Collection<Object> values) {
        if (values!= null) {
    ...
    @Override
    public Times withLocalId(String value) {
        setLocalId(value);
        return this;
    }
