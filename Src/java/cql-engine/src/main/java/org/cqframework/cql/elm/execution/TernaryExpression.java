 ...
 *       &lt;sequence&gt;
 *         &lt;element name="operand" type="{urn:hl7-org:elm:r1}Expression" maxOccurs="3" minOccurs="3"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/extension&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "TernaryExpression", namespace = "urn:hl7-org:elm:r1", propOrder = {
    "operand"
})
    ...
    implements Equals, HashCode, ToString
{
    ...
    public TernaryExpression withOperand(Expression... values) {
        if (values!= null) {
    ...
    public TernaryExpression withOperand(Collection<Expression> values) {
        if (values!= null) {
    ...
    @Override
    public TernaryExpression withAnnotation(Object... values) {
        if (values!= null) {
    ...
    @Override
    public TernaryExpression withAnnotation(Collection<Object> values) {
        if (values!= null) {
    ...
    @Override
    public TernaryExpression withLocalId(String value) {
        setLocalId(value);
        return this;
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        final TernaryExpression that = ((TernaryExpression) object);
        {
