...
@XmlType(name = "DateTimeComponentFrom", namespace = "urn:hl7-org:elm:r1")
    ...
    implements Equals, HashCode, ToString
{
    ...
    public DateTimeComponentFrom withPrecision(DateTimePrecision value) {
        setPrecision(value);
        return this;
    }

    @Override
    public DateTimeComponentFrom withOperand(Expression value) {
        setOperand(value);
        return this;
    }

    @Override
    public DateTimeComponentFrom withAnnotation(Object... values) {
        if (values!= null) {
    ...
    @Override
    public DateTimeComponentFrom withAnnotation(Collection<Object> values) {
        if (values!= null) {
    ...
    @Override
    public DateTimeComponentFrom withLocalId(String value) {
        setLocalId(value);
        return this;
    }

    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof DateTimeComponentFrom)) {
            return false;
        }
        if (this == object) {
            return true;
        ...
        final DateTimeComponentFrom that = ((DateTimeComponentFrom) object);
        {
