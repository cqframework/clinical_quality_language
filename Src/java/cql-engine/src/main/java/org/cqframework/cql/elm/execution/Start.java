...
@XmlType(name = "Start", namespace = "urn:hl7-org:elm:r1")
public class Start
    ...
    implements Equals, HashCode, ToString
{
    ...
    @Override
    public Start withOperand(Expression value) {
        setOperand(value);
        return this;
    }

    @Override
    public Start withAnnotation(Object... values) {
        if (values!= null) {
    ...
    @Override
    public Start withAnnotation(Collection<Object> values) {
        if (values!= null) {
    ...
    @Override
    public Start withLocalId(String value) {
        setLocalId(value);
        return this;
    }
