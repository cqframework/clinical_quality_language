...
/**
 * The Before operator is defined for Intervals, as well as DateTime values.
 * 			
    ...
    implements Equals, HashCode, ToString
{
    ...
    @Override
    public Before withOperand(Collection<Expression> values) {
        if (values!= null) {
    ...
    @Override
    public Before withAnnotation(Object... values) {
        if (values!= null) {
    ...
    @Override
    public Before withAnnotation(Collection<Object> values) {
        if (values!= null) {
