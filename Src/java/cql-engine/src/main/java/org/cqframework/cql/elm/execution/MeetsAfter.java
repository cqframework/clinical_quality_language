 ...
 * 
 * <p>Java class for MeetsAfter complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="MeetsAfter"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "MeetsAfter", namespace = "urn:hl7-org:elm:r1")
public class MeetsAfter
    ...
    implements Equals, HashCode, ToString
{
    ...
    public MeetsAfter withPrecision(DateTimePrecision value) {
        setPrecision(value);
        return this;
    }

    @Override
    public MeetsAfter withOperand(Expression... values) {
        if (values!= null) {
    ...
    @Override
    public MeetsAfter withOperand(Collection<Expression> values) {
        if (values!= null) {
    ...
    @Override
    public MeetsAfter withAnnotation(Object... values) {
        if (values!= null) {
    ...
    @Override
    public MeetsAfter withAnnotation(Collection<Object> values) {
        if (values!= null) {
    ...
    @Override
    public MeetsAfter withLocalId(String value) {
        setLocalId(value);
        return this;
    }

    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof MeetsAfter)) {
            return false;
        }
        if (this == object) {
            return true;
        ...
        final MeetsAfter that = ((MeetsAfter) object);
        {
