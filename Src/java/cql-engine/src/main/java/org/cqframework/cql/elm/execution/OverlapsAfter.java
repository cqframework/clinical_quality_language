...
@XmlType(name = "OverlapsAfter", namespace = "urn:hl7-org:elm:r1")
    ...
    implements Equals, HashCode, ToString
{
    ...
    public OverlapsAfter withPrecision(DateTimePrecision value) {
        setPrecision(value);
        return this;
    }

    @Override
    public OverlapsAfter withOperand(Expression... values) {
        if (values!= null) {
    ...
    @Override
    public OverlapsAfter withOperand(Collection<Expression> values) {
        if (values!= null) {
    ...
    @Override
    public OverlapsAfter withAnnotation(Object... values) {
        if (values!= null) {
    ...
    @Override
    public OverlapsAfter withAnnotation(Collection<Object> values) {
        if (values!= null) {
    ...
    @Override
    public OverlapsAfter withLocalId(String value) {
        setLocalId(value);
        return this;
    }

    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof OverlapsAfter)) {
            return false;
        }
        if (this == object) {
            return true;
        ...
        final OverlapsAfter that = ((OverlapsAfter) object);
        {
