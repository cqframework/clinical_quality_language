...
@XmlType(name = "Count", namespace = "urn:hl7-org:elm:r1")
public class Count
    ...
    implements Equals, HashCode, ToString
{
    ...
    @Override
    public Count withSource(Expression value) {
        setSource(value);
        return this;
    }

    @Override
    public Count withPath(String value) {
        setPath(value);
        return this;
    }

    @Override
    public Count withAnnotation(Object... values) {
        if (values!= null) {
    ...
    @Override
    public Count withAnnotation(Collection<Object> values) {
        if (values!= null) {
    ...
    @Override
    public Count withLocalId(String value) {
        setLocalId(value);
        return this;
    }
