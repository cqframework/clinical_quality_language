...
@XmlType(name = "Starts", namespace = "urn:hl7-org:elm:r1")
public class Starts
    ...
    implements Equals, HashCode, ToString
{
    ...
    public Starts withPrecision(DateTimePrecision value) {
        setPrecision(value);
        return this;
    }

    @Override
    public Starts withOperand(Expression... values) {
        if (values!= null) {
    ...
    @Override
    public Starts withOperand(Collection<Expression> values) {
        if (values!= null) {
    ...
    @Override
    public Starts withAnnotation(Object... values) {
        if (values!= null) {
    ...
    @Override
    public Starts withAnnotation(Collection<Object> values) {
        if (values!= null) {
    ...
    @Override
    public Starts withLocalId(String value) {
        setLocalId(value);
        return this;
    }

    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof Starts)) {
            return false;
        }
        if (this == object) {
            return true;
        ...
        final Starts that = ((Starts) object);
        {
