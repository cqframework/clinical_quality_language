...
@XmlType(name = "NaryExpression", namespace = "urn:hl7-org:elm:r1", propOrder = {
    "operand"
})
@XmlSeeAlso({
    Coalesce.class,
    ...
    implements Equals, HashCode, ToString
{
    ...
    public NaryExpression withOperand(Expression... values) {
        if (values!= null) {
    ...
    public NaryExpression withOperand(Collection<Expression> values) {
        if (values!= null) {
    ...
    @Override
    public NaryExpression withAnnotation(Object... values) {
        if (values!= null) {
    ...
    @Override
    public NaryExpression withAnnotation(Collection<Object> values) {
        if (values!= null) {
    ...
    @Override
    public NaryExpression withLocalId(String value) {
        setLocalId(value);
        return this;
    }

    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof NaryExpression)) {
            return false;
        }
        if (this == object) {
            return true;
        ...
        final NaryExpression that = ((NaryExpression) object);
        {
