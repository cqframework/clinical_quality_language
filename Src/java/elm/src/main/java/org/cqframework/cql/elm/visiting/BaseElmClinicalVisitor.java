...
public abstract class BaseElmClinicalVisitor<T, C> extends BaseElmVisitor<T, C> implements ElmClinicalVisitor<T, C> {
    ...
    public T visitElement(Element elm, C context) {
        ...
        else if (elm instanceof CodeDef)
            return visitCodeDef((CodeDef) elm, context);
        else if (elm instanceof CodeSystemDef)
            return visitCodeSystemDef((CodeSystemDef) elm, context);
        else if (elm instanceof ValueSetDef)
            return visitValueSetDef((ValueSetDef) elm, context);
        else if (elm instanceof ConceptDef)
            return visitConceptDef((ConceptDef) elm, context);
        else if (elm instanceof CodeFilterElement)
            return visitCodeFilterElement((CodeFilterElement) elm, context);
        else if (elm instanceof DateFilterElement)
            return visitDateFilterElement((DateFilterElement) elm, context);
        else if (elm instanceof OtherFilterElement)
            return visitOtherFilterElement((OtherFilterElement) elm, context);
        else if (elm instanceof IncludeElement)
            return visitIncludeElement((IncludeElement) elm, context);
    ...
    public T visitExpression(Expression elm, C context) {
        ...
        else if (elm instanceof CodeSystemRef)
            return visitCodeSystemRef((CodeSystemRef) elm, context);
        else if (elm instanceof ValueSetRef)
            return visitValueSetRef((ValueSetRef) elm, context);
        else if (elm instanceof CodeRef)
            return visitCodeRef((CodeRef) elm, context);
        else if (elm instanceof ConceptRef)
            return visitConceptRef((ConceptRef) elm, context);
        else if (elm instanceof Code)
            return visitCode((Code) elm, context);
        else if (elm instanceof Concept)
            return visitConcept((Concept) elm, context);
        else if (elm instanceof Quantity)
            return visitQuantity((Quantity) elm, context);
        else if (elm instanceof Ratio)
            return visitRatio((Ratio) elm, context);
        else if (elm instanceof Retrieve)
            return visitRetrieve((Retrieve) elm, context);
        else
    ...
    public T visitOperatorExpression(OperatorExpression elm, C context) {
        if (elm instanceof InCodeSystem)
            return visitInCodeSystem((InCodeSystem) elm, context);
        else if (elm instanceof AnyInCodeSystem)
            return visitAnyInCodeSystem((AnyInCodeSystem) elm, context);
        else if (elm instanceof InValueSet)
            return visitInValueSet((InValueSet) elm, context);
        else if (elm instanceof AnyInValueSet)
            return visitAnyInValueSet((AnyInValueSet) elm, context);
        else
    ...
    public T visitUnaryExpression(UnaryExpression elm, C context) {
        if (elm instanceof ExpandValueSet)
            return visitExpandValueSet((ExpandValueSet) elm, context);
        if (elm instanceof CalculateAge)
            return visitCalculateAge((CalculateAge) elm, context);
        else
    ...
    public T visitBinaryExpression(BinaryExpression elm, C context) {
        if (elm instanceof CalculateAgeAt)
            return visitCalculateAgeAt((CalculateAgeAt) elm, context);
        else if (elm instanceof Subsumes)
            return visitSubsumes((Subsumes) elm, context);
        else if (elm instanceof SubsumedBy)
            return visitSubsumedBy((SubsumedBy) elm, context);
        else
