 ...
 * type.
 */
public class FunctionalElmLibraryVisitor<T, C> extends BaseElmLibraryVisitor<T, C> {
     ...
     */
    public FunctionalElmLibraryVisitor(BiFunction<Trackable, C, T> defaultResult, BiFunction<T, T, T> aggregateResult) {
