...
class FunctionalElmVisitorTest {
    ...
    void constructVisitorTest() {
        // set up visitor that counts all visited elements
        var trackableCounter = FunctionalElmVisitor.from((elm, context) -> 1, Integer::sum);
        ...
        var contextReturner = FunctionalElmVisitor.from((t, c) -> c);
    ...
    void nullFactoryTest() {
        assertThrows(NullPointerException.class, () -> FunctionalElmVisitor.from(null));
        assertThrows(NullPointerException.class, () -> FunctionalElmVisitor.from(null, null));
        assertThrows(NullPointerException.class, () -> FunctionalElmVisitor.from(null, (a, b) -> b));
        assertThrows(NullPointerException.class, () -> FunctionalElmVisitor.from((t, c) -> null, null));
    }
}
