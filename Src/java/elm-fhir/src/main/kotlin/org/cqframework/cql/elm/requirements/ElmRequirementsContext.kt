...
class ElmRequirementsContext(
    ...
    val parameters: MutableMap<String, CqlType?>?
    ...
    fun exitPertinenceContext() {
        if (pertinenceContextStack.isNotEmpty()) {
     ...
     */
    private val _reportedRequirements: MutableMap<ExpressionDef, ElmRequirements> = mutableMapOf()

    fun getReportedRequirements(): Collection<ElmRequirements> {
        return _reportedRequirements.values
    }

    fun getReportedRequirements(ed: ExpressionDef?): ElmRequirements? {
        return _reportedRequirements[ed]
    }
     ...
     */
    private val _inferredRequirements: MutableMap<ExpressionDef, ElmRequirement?> = mutableMapOf()

    fun getInferredRequirements(): Collection<ElmRequirement> {
