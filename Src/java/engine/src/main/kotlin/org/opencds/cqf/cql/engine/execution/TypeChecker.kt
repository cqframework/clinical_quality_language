...
object TypeChecker {
    ...
    private val logger: Logger = LoggerFactory.getLogger(TypeChecker::class.java)
    ...
    fun checkType(
        ...
        return when (expectedResultTypeName.namespaceURI) {
            "urn:hl7-org:elm-types:r1" ->
                when (expectedResultTypeName.localPart) {
