...
//    }
//
//    private void evaluateLets(State state, List<Variable> letVariables) {
//        for (int i = 0; i < getLet().size(); i++) {
//            letVariables.get(i).setValue(getLet().get(i).getExpression().evaluate(state));
//        }
//    }
//
...
//    }
//
//    private Object evaluateReturn(State state, List<Variable> variables, List<Object> elements) {
//        return elm.getReturn() != null ? this.getReturn().getExpression().evaluate(state) : constructResult(state, variables, elements);
//    }
//
...
//
//                evaluateLets(state, letVariables);
//
//                // Evaluate relationships
//                if (!evaluateRelationships(state)) {
//                    continue;
//                }
//
//                if (!evaluateWhere(state)) {
//                    continue;
//                }
//
//                result.add(evaluateReturn(state, variables, elements));
//            }
//        }
//        finally {
//            while (pushCount > 0) {
