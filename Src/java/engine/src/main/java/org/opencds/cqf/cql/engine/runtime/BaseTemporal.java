...
public abstract class BaseTemporal implements CqlType, Comparable<BaseTemporal> {
    ...
    public static String getHighestPrecision(BaseTemporal... values) {
        ...
        return isDateTime
                ? Precision.fromDateTimeIndex(max).toString()
                : isDate
                        ? Precision.fromDateIndex(max).toString()
                        : Precision.fromTimeIndex(max).toString();
    }
    ...
    public static String getLowestPrecision(BaseTemporal... values) {
        ...
        return isDateTime
                ? Precision.fromDateTimeIndex(min).toString()
                : isDate
                        ? Precision.fromDateIndex(min).toString()
                        : Precision.fromTimeIndex(min).toString();
    }
