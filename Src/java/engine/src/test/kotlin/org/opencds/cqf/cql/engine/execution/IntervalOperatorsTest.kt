...
internal class IntervalOperatorsTest : CqlTestBase() {
    ...
    fun all_interval_operators() {
        ...
        Assertions.assertTrue(
            ((value as MutableList<*>)[0] as Interval).equal(Interval(1, true, 10, true))
        )
        Assertions.assertTrue((value[1] as Interval).equal(Interval(12, true, 19, true)))

        value = results.forExpression("IntegerIntervalCollapse2").value()
        Assertions.assertTrue(
            ((value as MutableList<*>)[0] as Interval).equal(Interval(1, true, 19, true))
        )

        value = results.forExpression("IntegerIntervalCollapse3").value()
        Assertions.assertTrue(
            ((value as MutableList<*>)[0] as Interval).equal(Interval(4, true, 8, true))
        )

        value = results.forExpression("IntegerIntervalCollapse4").value()
        Assertions.assertTrue(
            ((value as MutableList<*>)[0] as Interval).equal(Interval(4, true, 6, true))
        )
        Assertions.assertTrue((value[1] as Interval).equal(Interval(8, true, 10, true)))
        ...
        Assertions.assertTrue(
            EquivalentEvaluator.equivalent((value[0] as Interval).end, Date(2018, 8, 28))
        )
        Assertions.assertTrue(
            EquivalentEvaluator.equivalent((value[1] as Interval).start, Date(2018, 8, 30))
        )
        Assertions.assertTrue(
            EquivalentEvaluator.equivalent((value[1] as Interval).end, Date(2018, 10, 15))
        )
        ...
        Assertions.assertTrue(
            EquivalentEvaluator.equivalent((value[0] as Interval).end, Date(2018, 10, 15))
        )
        ...
        Assertions.assertTrue(EquivalentEvaluator.equivalent(value, Time(23, 59, 59, 599)))
        ...
        Assertions.assertTrue((value as Interval).equal(Interval(1, true, 3, true)))

        value = results.forExpression("IntegerIntervalExcept4to6").value()
        Assertions.assertTrue((value as Interval).equal(Interval(-4, false, 6, false)))
        ...
        Assertions.assertTrue((value as Interval).equal(Interval(1, true, 2, true)))
        ...
        Assertions.assertTrue(
            EquivalentEvaluator.equivalent(value.end, DateTime(bigDecimalZoneOffset, 2012, 1, 16))
        )

        value = results.forExpression("ExceptTimeInterval").value()
        Assertions.assertTrue(
            EquivalentEvaluator.equivalent((value as Interval).start, Time(5, 59, 59, 999))
        )
        Assertions.assertTrue(EquivalentEvaluator.equivalent(value.end, Time(8, 59, 59, 998)))

        value = results.forExpression("ExceptTime2").value()
        Assertions.assertTrue(
            EquivalentEvaluator.equivalent((value as Interval).start, Time(11, 0, 0, 0))
        )
        Assertions.assertTrue(EquivalentEvaluator.equivalent(value.end, Time(11, 59, 59, 999)))
        ...
        // just gives null).
        Assertions.assertTrue((value as Interval).equivalent(Interval(null, false, 5, true)))

        value = results.forExpression("TestIntersectNullRightEnd").value()
        Assertions.assertTrue((value as Interval).equivalent(Interval(5, true, null, false)))
        ...
        Assertions.assertTrue((value as Interval).equal(Interval(4, true, 10, true)))
        ...
        Assertions.assertTrue(
            (value as Interval).equal(Interval(BigDecimal("4.0"), true, BigDecimal("10.0"), true))
        )
        ...
        Assertions.assertTrue(
            EquivalentEvaluator.equivalent(value.end, DateTime(bigDecimalZoneOffset, 2012, 1, 10))
        )

        value = results.forExpression("TimeIntersect").value()
        Assertions.assertTrue(
            EquivalentEvaluator.equivalent((value as Interval).start, Time(4, 59, 59, 999))
        )
        Assertions.assertTrue(EquivalentEvaluator.equivalent(value.end, Time(6, 59, 59, 999)))
        ...
        Assertions.assertTrue(
            (value as Quantity).equal(Quantity().withValue(BigDecimal("1.0")).withUnit("g"))
        )
        ...
        Assertions.assertTrue(EquivalentEvaluator.equivalent(value, Time(0, 0, 0, 0)))
        ...
        Assertions.assertTrue((value as Interval).equal(Interval(1, true, 15, true)))
        ...
        Assertions.assertTrue(
            (value as Interval).equal(Interval(BigDecimal("1.0"), true, BigDecimal("15.0"), true))
        )
        ...
        Assertions.assertTrue(
            EquivalentEvaluator.equivalent(value.end, DateTime(bigDecimalZoneOffset, 2012, 1, 28))
        )
        ...
        Assertions.assertTrue(EquivalentEvaluator.equivalent(value.end, Time(20, 59, 59, 999)))
