...
public class IncludedValueSetRefTest {
    ...
    public void test_all_included_valueset() {
        ...
        evaluationResult = engine.evaluate(CqlTestBase.toElmIdentifier("IncludedValueSetRefTest"), null, null, null, null, null);

        @SuppressWarnings("unchecked")
        List<Code> actual = (List<Code>) evaluationResult.forExpression("IncludedValueSet").value();
