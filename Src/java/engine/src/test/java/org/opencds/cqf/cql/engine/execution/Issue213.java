...
class Issue213 extends CqlTestBase {
    ...
    void interval() {
        ...
        //        Assertions.assertTrue(EquivalentEvaluator.equivalent(((Interval) ((List) value).get(0)).getStart(),
        // new
        ...
        //        Assertions.assertTrue(EquivalentEvaluator.equivalent(((Interval) ((List) value).get(1)).getStart(),
        // new
