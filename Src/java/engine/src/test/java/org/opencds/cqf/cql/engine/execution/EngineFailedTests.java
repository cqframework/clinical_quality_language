...
public class EngineFailedTests extends CqlTestBase {
    ...
    public void test_all_failed_tests() throws Exception {
        ...
        try{
            evaluationResult = engine.evaluate(toElmIdentifier("CqlAllFailedTests"), Set.of("PredecessorUnderflowT"), null, null, null, null);
        }catch(RuntimeException re){
            assertThat(re.getMessage(),is("The result of the successor operation precedes the minimum value allowed for the Time type"));
        }

        try{
            evaluationResult = engine.evaluate(toElmIdentifier("CqlAllFailedTests"), Set.of("SuccessorOverflowDt"), null, null, null, null);
            Assert.fail();
        }catch(RuntimeException re){
        ...
        try{
            evaluationResult = engine.evaluate(toElmIdentifier("CqlAllFailedTests"), Set.of("SuccessorOverflowT"), null, null, null, null);
            Assert.fail();
        }catch(RuntimeException re){
        ...
        try {
            evaluationResult = engine.evaluate(toElmIdentifier("CqlAllFailedTests"), Set.of("DateTimeAddInvalidYears"), null, null, null, null);
            Assert.fail();
        ...
        try {
            evaluationResult = engine.evaluate(toElmIdentifier("CqlAllFailedTests"), Set.of("DateTimeDurationBetweenUncertainDiv"), null, null, null, null);
            Assert.fail();
        } catch (RuntimeException re) {
            // pass
        }
        ...
        try {
            evaluationResult = engine.evaluate(toElmIdentifier("CqlAllFailedTests"), Set.of("DateTimeSubtractInvalidYears"), null, null, null, null);
            Assert.fail();
        } catch (InvalidDateTime ae) {
            // pass
        }
