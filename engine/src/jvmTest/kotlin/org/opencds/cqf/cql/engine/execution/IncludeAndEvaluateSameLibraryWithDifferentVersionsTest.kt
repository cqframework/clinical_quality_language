...
internal class IncludeAndEvaluateSameLibraryWithDifferentVersionsTest {
     ...
     * respectively. LibB re-exports expression x from LibD version 1.0.0. LibC re-exports
     * expression x from LibD version 2.0.0. The test ensures that the engine can evaluate LibA
     * which accesses LibB.x and LibC.x.
     */
    @Test
