...
Build the CQL engine and its dependencies locally by running the `:engine-fhir:build` task.
This will output the JS and WASM/JS packages to `../../build/(js|wasm)/packages/engine-fhir`.
